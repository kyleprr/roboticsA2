%% The following links were used to help write and create the code displayed below. Credited to them for sections of the code:
%% Lecturer: Gavin Paul with help on displaying the robot and jogging functions.
%% Online:
% https://www.youtube.com/watch?v=xF1KaINQwa8
% https://github.com/ME435/MATLAB-Robot-Arm-GUI-Start
% A GUI Based Kinematic Model Development OF 6 DOF Manipulator Using Matlab by Sundara Mahalingam.V

% modified and used for incorporation into robotics assignment 2
...
% Last Modified by GUIDE v2.5 08-Jun-2020 19:39:58
...
%       0 0 0 1];
%  
%  J = handles.model.ikine(T,[0 0 0],'mask',[1 1 1 0 0 0])*180/pi;
%  handles.model.plot(J*pi/180);
...
%       hListener = addlistener(hGui,'Visible', 'PostSet',@e_stop_Callback);
%       doLoop = true;
%       k      = 1;
%       while doLoop
